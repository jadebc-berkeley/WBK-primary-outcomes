capture log close
log using "~/documents/crg/wash-benefits/Kenya/src/primary/dm/1_make_diarr_data_blind.log", replace
...
* Child diarrhea
* ---------------------------------------------	
use "Baseline/msP_bl_child_diarr_20161010.dta", clear
tostring childid hhid, replace

* at baseline, some children had diarrhea recorded twice
* Charles said to use the first measurement.
tab threedefa_*, mis
tab softa_*, mis
tab blooda_*, mis
tab threedefd_*, mis
...
* Child diarrhea
* ---------------------------------------------
use "Midline/msP_ml_child_diarr_20161010.dta", clear
...
* Child diarrhea
* ---------------------------------------------
use "Endline/msP_el_child_diarr_20161010.dta", clear
tostring childid hhid, replace
...
* at the uptake measurement. charles said to use the anthro day 
* measure 
...
outsheet using "~/Dropbox/WBK-primary-analysis/Data/Final/Jade/diarrhea.csv", replace comma 
save  "~/Dropbox/WBK-primary-analysis/Data/Final/Jade/diarrhea.dta", replace 
