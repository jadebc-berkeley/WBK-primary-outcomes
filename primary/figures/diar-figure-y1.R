...
load("~/Dropbox/WBK-primary-analysis/results/jade/diar_y1_rd_unadj.RData")
load("~/Dropbox/WBK-primary-analysis/results/jade/diar_y1_pr_unadj.RData")
...
t0p <- diar_t0_prev_j
t1p <- diar_t1_prev_j
fuPrev <- diar_t1_prev_j

h1pr <- diar_y1_h1_pr_unadj_j
h2pr <- diar_y1_h2_pr_unadj_j
# h3pr <- diar_y1_h3_pr_unadj_A
h3pr <- diar_y1_h3_pr_unadj_j
...
#--------------------------------------------------------------------
#Alternative figure:
#Adding in H3 comparisons (WSH+N vs. WSH and WHS+N vs. N)
#--------------------------------------------------------------------
try(setwd("C:/Users/andre/Dropbox/WBK-primary-analysis/Results/Figures/"))
pdf("kenya-diar-y1-alt.pdf",width=14,height=4)
