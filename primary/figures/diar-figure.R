...
h3pr <- diar_h3_pr_unadj_A

try(setwd("C:/Users/andre/"))
pdf("~/Dropbox/WBK-primary-analysis/Results/Figures/kenya-diar.pdf",width=14,height=4)
...
pdf("kenya-diar-alt.pdf",width=14,height=4)
