...
# output: sstunt_t1_pval_adj.RData, sstunt_t2_pval_adj.RData
...
save(sstunt_t1_h1_pval_adj_j,sstunt_t1_h3_pval_adj_j,
     file=here("primary/res_data/sstunt_t1_pval_adj.RData"))

save(sstunt_t2_h1_pval_adj_j,sstunt_t2_h3_pval_adj_j,
     file=here("primary/res_data/sstunt_t2_pval_adj.RData"))
